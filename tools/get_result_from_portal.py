...
#base_url='https://reportportal-acmqe.apps.dno.ocp-hub.prod.psi.redhat.com'
#base_url='https://reportportal-openshift.apps.dno.ocp-hub.prod.psi.redhat.com'
#rp_api_token='yh-for-test_jRIu6pn-QsqJZqOlWI7fB9XJBFP8GRo2sLdyjEvkQ6qUQDsvnQ_OZLLxnBJJGbPL'
#rp_api_token='mihuang-api-yh_9ZRkeRF8QUKAjDpmY2ES44yn3PIB-wKyA12eDOa21Qil15REEhtXwUIbR2Fbf8g9'
headers = {'Authorization': 'Bearer ' + rp_api_token, "Content-Type": "application/json"}
#project = 'acmqe-autotest'
#project='prow'
